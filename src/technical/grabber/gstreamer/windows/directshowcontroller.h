...
#ifndef GSTREAMER_WINDOWS_DIRECTSHOWCONTROLLER_H
...
/**
 * Interface to the controller using Microsoft DirectShow API.
 *
 * @author Ralf Lange
 */
class DirectShowController : public GrabberController
{
public:
