...
void GstreamerVideoTestGrabber::initializationSubclass()
{
...
void GstreamerVideoTestGrabber::initSubclass()
{
...
{
    qDebug() << "GstreamerVideoTestGrabber::event_loop --> Start";
    qDebug() << "Got " << GST_MESSAGE_TYPE_NAME (message) << " message";

    switch (GST_MESSAGE_TYPE (message)) {
    case GST_MESSAGE_EOS:
        qDebug() << "GstreamerVideoTestGrabber::event_loop --> Message EOS";

        // g_main_loop_quit(GstreamerVideoTestGrabber::loop);
        break;
    case GST_MESSAGE_INFO:{
            qDebug() << "GstreamerVideoTestGrabber::event_loop --> Message INFO";
    ...
    case GST_MESSAGE_WARNING:{
            qDebug() << "GstreamerVideoTestGrabber::event_loop --> Message WARNING";
    ...
    case GST_MESSAGE_ERROR:{
            qDebug() << "GstreamerVideoTestGrabber::event_loop --> Message ERROR";
