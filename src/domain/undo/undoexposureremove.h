...
public:
     ...
     * @arg scIndex the index of the scene of the exposure to remove
     * @arg taIndex the index of the take of the exposure to remove
     * @arg exIndex the index of the exposure to remove
     */
