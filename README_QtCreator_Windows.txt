...
1.1.1.1 Install MS Visual Studio 2008 (Express or Professional)
...
* Download the latest version of "Debugging Tools for Windows" from the Microsoft Web site
  "http://msdn.microsoft.com/en-us/windows/hardware/gg463016.aspx"
* Install in the default installation directory.

1.1.2 Install the Windows SDK
* Download the Windows SDK for .NET 3.5 including the Visual Studio 2008 command line tools
...
* Download Qt Creator 2.1.0 for Windows (not the full SDK) from qt.nokia.com/downloads
* Install in the Directory C:\Tools\Qt\...
